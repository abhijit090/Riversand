...
describe('Navistar', ()=>
{
    ...
    cy.wait(30000)
     ...
     cy.wait(6000) 
    //select file
    cy.get('pebble-bulk-file-upload[id="fileUpload"]').find('input[type="file"]').selectFile('C:\\Users\\AJadhav\\Sager_gitClone_pull\\Chic-Fila\\cypress\\fixtures\\Auto_test2.xlsx',{force: true})
     cy.wait(6000)
